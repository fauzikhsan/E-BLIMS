...
class TeknikInformatika extends StatefulWidget {
  const TeknikInformatika({super.key});

  @override
  State<TeknikInformatika> createState() => _TeknikInformatikaState();
}

class _TeknikInformatikaState extends State<TeknikInformatika> {
